...
"""family_1 = input("Введите текст через запятую: ").split(",")
family_2 = input("Введите текст через запятую: ").split(",")
...
"""my_dict = {
    ...
    'budget': 3000,
    'main_actor': 'Nif_Nif',
    'slogan': 'Ne strojte dom na peske'
}
print(my_dict)
print(my_dict['title'])
